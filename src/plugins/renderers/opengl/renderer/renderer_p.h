...
class OPENGL_RENDERER_EXPORT Renderer : public AbstractRenderer
{
public:
    ...
    bool accessOpenGLTexture(Qt3DCore::QNodeId nodeId, QOpenGLTexture **texture, QMutex **lock) override;
